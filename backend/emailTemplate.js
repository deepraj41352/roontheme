const emailTemplate = (options) => {
  const templateHead = `<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional //EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
  <html
                                    ...
                                    <tr>
                                      ...
                                      >
                                        <a href="/" class="navbar-brand">
                                          <img
                                            src="https://roonberg.onrender.com/logo2.png"
...
`;
  ...
  switch (options.template) {
                          ...
                          <tr>
                            ...
                            >
                              <img
                                align="center"
                                border="0"
                                src="https://res.cloudinary.com/dmhxjhsrl/image/upload/v1700656076/thfunv80gefr59rsnnnv.png"
                                alt="Image"
                                title="Image"
                                style="
                                  outline: none;
                          ...
                          <p style="font-size: 14px; line-height: 140%">
                            <span
                              style="
                                ...
                                color: #666666;
                              "
                              >New project created with the following details:
                            </span>
                          </p>
                        </div>
                      </td>
                          ...
                          <p style="font-size: 14px; line-height: 140%">
                            <span
                              style="
                                ...
                                color: #666666;
                              "
                              >To create your password, please follow the link
                              below:
                            </span>
                          </p>
                        </div>
                          ...
                          <p style="font-size: 14px; line-height: 140%">
                            <span
                              style="
                                ...
                                color: #666666;
                              "
                              >We're excited to have you get started. First, you
                              need to confirm your account. Just press the button
                              below.
                            </span>
                          </p>
                        </div>
    ...
    default:
      // Handle the default case if options.template doesn't match any case
